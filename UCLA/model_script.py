...
#spec = importlib.util.spec_from_file_location("module_name", "abstract_model.py")
#module = importlib.util.module_from_spec(spec)
##spec.loader.exec_module(module)
#YourClass = module.AbstractModel

# Now you can use YourClass as usual
#Abstract = YourClass()

#Is there a way to find out the anomaly datapoints among the dataset?
...
if __name__ == "__main__":
    ...
    binary_performance_test["p-val"] = pd.to_numeric(binary_performance_test["p-val"], errors='coerce')
    binary_performance_test.dropna(subset=['p-val'], inplace=True)
